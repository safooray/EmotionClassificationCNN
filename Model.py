	...
	with tf.Session() as sess:
		...
		for step in xrange(int(NUM_EPOCHS * train_size / BATCH_SIZE)):
			...
			if step % SAVE_FREQUENCY == 0:
				numpy.save(os.path.join(os.getcwd(),'loss3.npy'), train_loss_list) 
				numpy.save(os.path.join(os.getcwd(),'trn_err3.npy'), train_err_list) 
				numpy.save(os.path.join(os.getcwd(),'val_err3.npy'), val_err_list) 
				save_path = saver.save(sess, "tmp3/model"+str(step)+".ckpt")
